...
public class Mago extends Personaje implements Magico, Vida {	
	 ...
	 * @param nacimiento El año de nacimiento del mago	 
	...
	/**
	 * Obtiene el maná que tiene el mago
	 * @return mana El maná del mago
	 */
	public int getMana() {
		return mana;
	}
	...
	/**
	 * Establece el maná que tiene el mago en base a su edad	 
	 */
	void setMana() {
		if(getEdad()<18)
	...
	/**
	 * Calcula el daño del hechizo normal del mago en base a su edad
	 * @return el daño del hechizo normal del mago
	 */
	@Override
	...
	/**
	 * Calcula el daño del hechizo fuerte del mago en base a su edad
	 * @return el daño del hechizo fuerte del mago
	 */
	@Override
